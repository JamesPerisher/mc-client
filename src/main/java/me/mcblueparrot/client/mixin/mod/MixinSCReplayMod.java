...
public class MixinSCReplayMod {
	...
	public static class MixinGuiSavingReplay {
		...
		public Object saveAnyway(SCSettingsRegistry instance, @SuppressWarnings("rawtypes") SCSettingsRegistry.SettingKey settingKey) {
	...
	public static class MixinPacketListener {
		...
		public void handleChat(@SuppressWarnings("rawtypes") Packet packet, CallbackInfo callback) {
